...
import "./tcgAssistantShowcase.scss";
                ...
                <div className="carousel-title-content">
                  <div className="project-overview">
                    ...
                    <h4>
                      ...
                      cards to and from your collection, create a wishlist, get
                      alerted when a card reaches a certain price, view a card's
                      price history, discover cards based on categories, and
                      more.
                    </h4>
